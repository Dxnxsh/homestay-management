...
<head>
    ...
    <title>Our Homestays - Serena Sanctuary</title>
    <link rel="icon" type="image/png" href="../images/logoNbg.png">
    <link rel="stylesheet" href="../css/htmlStyle/homestayStyle.css">
...
<body>
    ...
    <nav class="navbar">
        <div class="nav-container">
            ...
            <ul class="nav-menu" id="navMenu">
                ...
                <li><a href="../php/manager/dashboard.html" class="nav-link btn-signup">Sign Up</a></li>
                <li><a href="../php/login.php" class="nav-link btn-login">Login</a></li>
            </ul>
    ...
    <div class="page-header">
        <h1>Our Homestays</h1>
        <p>Discover our collection of beautifully designed homestays, each offering unique comfort and tranquility</p>
    </div>
                ...
                <?php foreach ($homestays as $hs): ?>
                    <div class="homestay-card"
                        ...
                        <div class="homestay-image">
                            <img src="../images/<?php echo htmlspecialchars($hs['meta']['folder']); ?>/<?php echo htmlspecialchars($hs['meta']['images'][0] ?? 'homestay1.jpg'); ?>"
                        ...
                        <div class="homestay-details">
                            ...
                            <a href="../php/login.php" class="btn btn-primary" onclick="event.stopPropagation()">Book
                                Now</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            ...
            <?php foreach ($homestays as $hs): ?>
                <div class="homestay-detail-card" id="homestay-detail-<?php echo htmlspecialchars($hs['id']); ?>">
                    <div class="detail-image-carousel">
                        <div class="carousel-container">
                            <?php foreach ($hs['meta']['images'] as $index => $img): ?>
                                <img src="../images/<?php echo htmlspecialchars($hs['meta']['folder']); ?>/<?php echo htmlspecialchars($img); ?>"
                                    alt="<?php echo htmlspecialchars($hs['name']); ?>"
                    ...
                    <div class="detail-content">
                        ...
                        <a href="../php/login.php" class="btn btn-primary">Book Now</a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-section">
                    ...
                    <p class="footer-description">Your trusted partner for exceptional homestay experiences and
