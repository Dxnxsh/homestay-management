...
CREATE TABLE HOMESTAY (
    homestayID        INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE MEMBERSHIP (
    membershipID  INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    guestID       INT UNIQUE,
...
-- =====================
CREATE TABLE BILL (
    billNo          INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    bill_date       DATE,
...
-- =====================
-- Note: homestayID will be auto-generated. staffID is set to NULL. Update with actual staffID after inserting STAFF data.
INSERT INTO HOMESTAY (homestay_name, homestay_address, office_phoneNo, rent_price, staffID) 
VALUES ('THE GRAND HAVEN', 'HULU LANGAT, SELANGOR', '+60 17-204 2390', 500.00, NULL);

INSERT INTO HOMESTAY (homestay_name, homestay_address, office_phoneNo, rent_price, staffID) 
VALUES ('TWIN HAVEN', 'HULU LANGAT, SELANGOR', '+60 17-204 2390', 450.00, NULL);

INSERT INTO HOMESTAY (homestay_name, homestay_address, office_phoneNo, rent_price, staffID) 
VALUES ('THE RIVERSIDE RETREAT', 'GOPENG, PERAK', '+60 17-204 2390', 400.00, NULL);

INSERT INTO HOMESTAY (homestay_name, homestay_address, office_phoneNo, rent_price, staffID) 
VALUES ('HILLTOP HAVEN', 'GOPENG, PERAK', '+60 17-204 2390', 550.00, NULL);
